...
/*
 * $Author: millz $
 * $Date: 2013-09-12 21:26:47 +0100 (Thu, 12 Sep 2013) $
 * $ID$
 * $Revision: 197 $
 * $URL: https://subversion.assembla.com/svn/honorbuddy-demonic/trunk/Demonic/Helpers/Bosslist.cs $
 * $LastChangedBy: millz $
 * $ChangesMade$
 */
#endregion
...
namespace Demonic.Helpers
{
    public static class BossList
    {
        ...
        #region Ignore AoE for These Bosses
        ...
        #region Ignoring Range checks for these bosses as blizzard loves to fuck with us botters.
        ...
        private static readonly HashSet<uint> _bosses = new HashSet<uint> {
            ...
            #region Siege of Orgrimmar (5.4)
            71543, // Immerseus
            71475, // The Fallen Protectors - Rook Stonetoe
            71479, // The Fallen Protectors - He Softfoot
            71480, // The Fallen Protectors - Sun Tenderheart
            72276, // Norushen
            71734, // Sha of Pride
            72249, // Galakras
            ...
            71454, // Malkorok
            71889, // WUT? ... Secured Stockpile of Pandaren Spoils
            ...
            #endregion Siege of Orgrimmar (5.4)

            #region Timeless Isle Rare Mobs (5.4)
            73174, //Archiereus
            72775, //Bufo
            73171, //Champion
            72045, //Chelon
